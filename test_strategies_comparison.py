...
# Configuration
TEST_FILE = r"C:\Users\oQaris\Desktop\Git\uc\examples\rts_gmlc\2020-05-05.json"
WINDOW_SIZE = 8
WINDOW_STEP = 8
GENERATORS_PER_ITERATION = 20  # None for classic R&F
GAP = 0.01
...
for strategy_key, strategy_info in STRATEGIES.items():
    ...
    try:
        result = solve_relax_and_fix(
            ...
            verbose=True,
            verify_solution=True,  # Skip verification for speed
            data=data,
